# Deneb Templates
## Line Chart Brush + Zoom
```json
{
  "usermeta": {
    "information": {
      "uuid": "840d27b9-555f-4845-9d50-736c8a643cb6",
      "generated": "2025-10-02T13:39:23.559Z",
  ...
  "vconcat": [ // Vertical concatenation: top chart + bottom chart
    {
      ...
      "mark": {
        ...
        "color": "#1E375A" // Dark blue line color
      },
      "encoding": {
        "x": {
    ...
    },
    {
      ...
      "mark": {
        ...
        "color": "#1E375A" // Same color as top chart
      },
      "encoding": {
        "x": {
          "field": "__0__",
